...
#define kBDKNotifyHUDDefaultOpacity      0.6f
...
//    CGRect frame = CGRectMake((screenRect.size.width - oldframe.size.width)/2, (screenRect.size.height - oldframe.size.height)/2, oldframe.size.width, oldframe.size.height);
