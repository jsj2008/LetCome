...
-(void)SQUAdaptor:(id)adaptor forSection:(QUSection*)section forEntity:(QUEntity*)entity;//兼容Swift

/** 选中某项Section时触发 */
-(void)QUAdaptor:(QUAdaptor *)adaptor selectedSection:(QUSection *)section entity:(QUEntity *)entity;
-(void)SQUAdaptor:(id)adaptor selectedSection:(QUSection *)section entity:(QUEntity *)entity;//兼容swift
...
/** table编辑代理 **/
- (void)MyQUTableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath;

/** table编辑代理 **/
- (BOOL)MyQUTableView:(UITableView *)tableView canEditRowAtIndexPath:(NSIndexPath *)indexPath ;
-(void)MyQUTableView:(UITableView *)tableView willBeginEditingRowAtIndexPath:(NSIndexPath*)indexPath;
-(void)MyQUTableView:(UITableView *)tableView didEndEditingRowAtIndexPath:(NSIndexPath*)indexPath;
