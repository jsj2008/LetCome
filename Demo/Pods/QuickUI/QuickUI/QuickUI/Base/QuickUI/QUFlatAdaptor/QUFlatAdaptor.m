...
+(UIColor *)getFlatColorLine{
    return QU_FLAT_COLOR_LINE;
}
+(UIColor *)getFlatColorCellBgSelected{
    return QU_FLAT_COLOR_CELL_BG_SELECTED;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    section.frame=CGRectMake(section.frame.origin.x, section.frame.origin.y, section.frame.size.width,info.frame.size.height);
...
//            section.frame=CGRectMake(section.frame.origin.x, section.frame.origin.y, section.frame.size.width,info.frame.size.height+1.f);
//            section.line_bottom.frame=CGRectMake(0, section.frame.size.height-1.f, section.frame.size.width,1.f);
//        }
    }
...
//    }
    ...
    
    {
        if(et.LineTopColor)
        {
            ...
            [section.line_top indentLineLevel:section.entity.pIndentTopLevel];
        }
        
        if(et.lineBottomColor){
            section.line_bottom.lineColor=et.lineBottomColor;
            [section.line_bottom indentLineLevel:section.entity.pIndentBottomLevel];
        }
    }
    ...
    if (indexPath.section == tableView.numberOfSections-1 && [self.delegate respondsToSelector:@selector(MyQUTableView:scrollToBottomSection:andEntity:)]) {
        [self.delegate MyQUTableView:tableView scrollToBottomSection:section andEntity:et];
    }
    return cell;
}
...
//    if(et.LineTopColor)
//    {
//        frame=CGRectMake(frame.origin.x, frame.origin.y, frame.size.width,frame.size.height+2.f);
//    }
//    else{
//        frame=CGRectMake(frame.origin.x, frame.origin.y, frame.size.width,frame.size.height+1.f);
//
//    }
    
    return frame.size.height+.1f;
}
