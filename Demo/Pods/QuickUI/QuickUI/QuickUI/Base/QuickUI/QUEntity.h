...
-(NSString*)parseJson:(NSDictionary*)json;//处理json数据,子类实现
...
@property(nonatomic,assign) int pIndentTopLevel;  // 缩进方式
@property(nonatomic,assign) int pIndentBottomLevel;  // 缩进方式
