...
@interface MyViewController : UIViewController<QUAdaptorDelegate,userValidateOperation,QUMockDelegate,QURefreshBaseViewDelegate>
...
@property(nonatomic,strong)NSHashTable *blls;//存放bll列表用于发送必要通知，保存弱引用,由QUBll负责存放

@property(strong ,nonatomic)UIView *titleView;

@property UIStatusBarStyle statusBarStyle;//状态栏颜色，默认黑色
